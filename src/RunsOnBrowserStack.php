...
trait RunsOnBrowserStack
{
    ...
    protected function detectOs(string $slug): array
    {
        ...
        preg_match(
            '/(MACOS_(SEQUOIA|SONOMA|VENTURA|MONTEREY|BIG_SUR|CATALINA|MOJAVE|HIGH_SIERRA|SIERRA|EL_CAPITAN|YOSEMITE|MAVERICKS|MOUNTAIN_LION|LION|SNOW_LEOPARD)|WINDOWS_(10|8(\.1)?|XP))/',
            $slug,
            $os
        );
